...
AODAIController::AODAIController()
{
	...
	SightConfig->SightRadius = 2500.0f; // Видит на 15 метров
	SightConfig->LoseSightRadius = 4000.0f; // Теряет из виду на 20 метрах
	SightConfig->PeripheralVisionAngleDegrees = 100.0f; // Угол обзора (как у человека)
